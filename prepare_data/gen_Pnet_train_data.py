...
# -*- coding: utf-8 -*-
"""
Created on Tue May 15 09:35:11 2018
        ...
        for box in boxes:
            ...
            for i in range(20):
                ...
                if IoU(crop_box, box_) >= 0.65:
                    ...
                    )  # positive samples with label 1 and offset
                    f1.write(
                        save_file
                        + " 1 %.2f %.2f %.2f %.2f\n"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="D:/CV/mtcnn_training/MTCNN_TRAIN/data/Widerface/WIDER_train/images/",
        type=str,
    )
...
if __name__ == "__main__":
    ...
    # gen_pnet_data('training_data', 'anno_store/wider_origin_anno.txt',  'D:/CV/mtcnn_training/data/Widerface/WIDER_train/images')
