...
# -*- coding: utf-8 -*-
"""
Created on Mon May 21 22:17:05 2018
...
def gen_rnet_data(
    data_dir, anno_file, pnet_model_file, prefix_path="", use_cuda=True, vis=False
):
    ...
    # save_file = 'D:/CV/mtcnn_training/MTCNN_TRAIN/model_store/pnet_detections_1527162101.pkl'
    ...
    for im_idx, dets, gts in zip(im_idx_list, det_boxes, gt_boxes_list):
        ...
        for box in dets:
            ...
            if (
                ...
                or x_left <= 0
                or y_top <= 0
                or x_right >= img.shape[1]
                or y_bottom >= img.shape[0]
            ):
                continue
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="dface train data temporary folder",
    ...
    parser.add_argument(
        ...
        default="D:/CV/mtcnn_training/MTCNN_TRAIN/model_store/pnet_model_final.pt",
        type=str,
    )
    parser.add_argument(
